...
@section('title', 'Free Trial Users')
                        ...
                        <table id="data-table" class="table table-striped table-bordered table-hover"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-success">{{ Carbon\Carbon::parse($u->start_date)->format('d M Y') }}</span></td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="7" class="text-center">No free trial users found.</td>
                                </tr>
                                @endforelse
